  ...
  return (
    <>
      <Modal onClick={handleModalCart}>
        ...
        <div className="sticky md:static inset-x-0 bottom-0">
          <div className="border-t border-gray-200 px-5 mt-4">
            ...
            <div className="flex items-center justify-between pb-2">
              <p className="">Total</p>
              <p className="font-bold text-lg">$ {totalPrices} USD</p>
            </div>
            <Button
              type="button"
              aria-label="Proceed to Checkout"
              title="Proceed to Checkout"
              classname="bg-pink-700 text-white font-bold w-full px-6 py-2 rounded-xl text-center leading-normal text-sm hover:bg-lime-600 transition duration-100 ease-in-out disabled:bg-gray-400 disabled:cursor-not-allowed mb-2"
        ...
        {/* <div className="flex flex-col gap-6 p-1 sm:p-2 w-full lg:w-[800px] relative">
          <div className="flex items-center justify-between">
            <div className="absolute top-3 left-0 z-[101]">
              <Button
                type="button"
            ...
            <div className="absolute top-4 z-[101] left-10 right-10">
          ...
          {totalItems === 0 ? (
            ...
            <div className="flex flex-col py-2 lg:py-14 px-3 gap-2 max-h-[500px] overflow-auto">
              {cartItems?.map((product) => {
                return (
                  <div
                    className="border-b-2 border-dashed border-gray-300 py-4 flex items-center space-x-3"
                    key={product?.id}
                  >
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center justify-between">
                        <h3 className="font-semibold">${product?.price} USD</h3>
                        <div className="flex items-center border border-gray-300 rounded-full overflow-hidden">
                          <Button
                            type="button"
                            aria-label="Minus Item"
          ...
          <div className="sticky md:static inset-x-0 bottom-0">
            <div className="border-t border-gray-200 px-5">
              ...
              <Button
                ...
                aria-label="Proceed to Checkout"
                title="Proceed to Checkout"
                classname="bg-pink-700 text-white font-bold w-full px-6 py-3.5 rounded-xl text-center leading-normal text-sm hover:bg-lime-600 transition duration-100 ease-in-out disabled:bg-gray-400 disabled:cursor-not-allowed"
                onClick={handleCheckoutToWhatsapp}
              >
                Proceed to Checkout (WhatsApp)
              </Button>
